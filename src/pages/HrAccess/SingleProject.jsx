    ...
    <div className="px-3 sm:px-12 md:px-12 pt-14 md:py-20">
      ...
      <div className="flex flex-col lg:flex-row mt-8">
        <div className="w-full lg:w-9/12">
          ...
          <p className="font-poppins mt-5">{project && project.description}</p>
        </div>
      ...
      <div className="flex mt-7">
        <div className="w-6/12 bg-slate-500 relative">
          <div className="bg-slate-600 py-1 flex items-center">
            ...
            <p
              ...
              onClick={() => setShowMExpenses(!showMExpenses)}
            >
              <BiDotsVertical />
            </p>
          </div>
        ...
        <div className="w-6/12 bg-slate-500 relative ml-1">
          <div className="bg-slate-600 py-1 flex items-center">
            <h4 className="  text-center font-bold text-white text-xl w-full">
              Labour Expenses
            </h4>
